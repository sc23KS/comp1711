...
int main() {
    /*success criteria:
    - read in file with no errors, 2.5 marks -> DONE
    - read in similar, unseen file no errors, 2.5 marks -> DONE
    - print number of records in file, 2.5 marks -> DONE
    - print out requested rows, 7.5 marks*/
